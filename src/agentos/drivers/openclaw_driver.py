...
class OpenClawDriver(OpenAIDriver):
    ...
    def __init__(self, name: str, config: dict[str, Any]) -> None:
        ...
        # ADR-0004: auto-wire telemetry hook so every chat() emits IN/OUT
        # events to G:/AgentOS/telemetry/{date}.jsonl. Honors
        # AGENTOS_TELEMETRY=off; idempotent under repeated construction.
